...
<template>
 ...
 <div class="row">
  <div class="col-md-12">
  <span class="float-right"><router-link to="/category" class="btn btn-info">Back to List </router-link></span>
  </div>
    ...
    <div class="row justify-content-center">
      ...
      <form class="user" @submit.prevent="categoryUpdate">
        ...
        <div class="form-group">
         ...
         <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Category Name" v-model="form.name">
