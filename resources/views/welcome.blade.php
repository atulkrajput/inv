...
<head>
  ...
  <title>Doon Portal Inventory - Dashboard</title>
  ...
  <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display:  none;"> 
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <router-link class="sidebar-brand d-flex align-items-center justify-content-center" to="/home">
        ...
        <div class="sidebar-brand-text mx-3">Doon Inventory</div>
      </router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/category">All Category</router-link>
      ...
      <li class="nav-item">
        <router-link class="nav-link" to="/shipment">
          <i class="far fa-fw fa-window-maximize"></i>
          <span>Shipments</span>
        </router-link>
      </li>
   ...
   <router-link class="collapse-item" to="/stocks">Full List</router-link>
   <router-link class="collapse-item" to="/stock-search">Search Stock</router-link>
   <router-link class="collapse-item" to="/stock-ledger">Stock Ledger</router-link>
   <router-link class="collapse-item" to="/adjustments">Adjustments</router-link>
      ...
      <li class="nav-item">
        <router-link class="nav-link" to="/imgresize">
          <i class="far fa-fw fa-window-maximize"></i>
          <span>Image Resize Tool</span>
        </router-link>
      </li>
      <li class="nav-item">
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <span id="year"></span> - developed by
              <b><a href="https://www.doonportal.com" target="_blank">Doon Portal</a></b>
            </span>
          </div>
        </div>
      </footer>
